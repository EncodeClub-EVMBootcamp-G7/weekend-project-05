...
import RouletteImage from './img/rb_13315.png'
...
const Home = () => {
  ...
  return (
    <div className='mx-auto w-3/4 flex mt-10 h-750 align-middle'>
      <div className="text-base md:text-lg lg:text-xl mr-16">
        <div className='container mx-auto py-8 bg-gradient-to-b from-violet-800 to-violet-900 rounded-lg p-4 mt-1/4 h-500 shadow-[0_4px_30px_rgba(0,0,0,0.5)]'>
          {/* Wallet Connection */}
          ...
          <div className='mb-6'>
            ...
            <button
              className='btn btn-primary mb-2 mx-1 bg-gradient-to-r from-yellow-500 to-amber-600 border border-white text-white'
              onClick={async () => {
                try {
                  await writeYourContractAsync({
...
const Roulette = () => {
  return <img className="hidden md:block" src={RouletteImage.src} alt='Roulette Image' style={{ maxWidth: '500px', height: 'auto' }} />
}
